...
//     - This is meant to be called as `AnyError.normalize(error)`
//  - Assigning a default class:
//     - Inside a top-level `catch` block
//     - For errors that are generic, either:
//        - Not `AnyError` instances
//        - `AnyError` itself
//     - This is meant to be called as `AnyError.normalize(error, UnknownError)`
...
//  - By opposition, `AnyError.normalize(error, UnknownError)` should be
